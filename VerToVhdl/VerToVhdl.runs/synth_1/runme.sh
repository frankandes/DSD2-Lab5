...
HD_PWD='C:/Users/Frank Andes/Documents/VScode_VHDL/DSD2-Lab5/VerToVhdl/VerToVhdl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MemoryStage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MemoryStage.tcl
