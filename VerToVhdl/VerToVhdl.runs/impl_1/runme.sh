...
HD_PWD='C:/Users/Frank Andes/Documents/VScode_VHDL/DSD2-Lab5/VerToVhdl/VerToVhdl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MemoryStage.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MemoryStage.tcl -notrace
